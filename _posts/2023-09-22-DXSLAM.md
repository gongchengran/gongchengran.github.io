...
# 3 主要结构
![image-67](../imgs/dxslam/image-67.png)
### 3.1 Feature Extraction
使用的是HF-Net,输出分别包含关键点、局部描述子和全局描述子  
![image-68](../imgs/dxslam/image-68.png)
...
![image-69](../imgs/dxslam/image-69.png)   
...
![image-70](../imgs/dxslam/image-70.png)  
---
结论：   
...
重定位评价指标定义如下  
![image-72](../imgs/dxslam/image-72.png)  

实验结果如下  

![image-71](../imgs/dxslam/image-71.png)   
...
![image-73](../imgs/dxslam/image-73.png)  
结论：  
...
![image-74](../imgs/dxslam/image-74.png)   
结论：  
1. 增量式训练词袋使得算法更高效合理（efficient and reasonable）  
2. DX-SLAM的表现更好   
#### Test on TUM RGB-D  
![image-75](../imgs/dxslam/image-75.png)
结论：  
...
![image-76](../imgs/dxslam/image-76.png)  
---
结论：  
